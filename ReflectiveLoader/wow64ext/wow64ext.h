...
typedef struct DECLSPEC_ALIGN(16) _M128A_ {
    ULONGLONG Low;
    LONGLONG High;
} M128A_, *PM128A_;
...
typedef _PEB_T<DWORD64, DWORD, 30> PEB64_WOW;
...
struct _XSAVE_FORMAT64
{
    ...
    DWORD MxCsr;
    DWORD MxCsr_Mask;
    _M128A_ FloatRegisters[8];
    _M128A_ XmmRegisters[16];
    BYTE Reserved4[96];
};
